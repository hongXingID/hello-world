...
const needTokenApi = [
  ...
  //saying的权限验证名单
  { method: "POST", path: "/api/saying" },
  { method: "DELETE", path: "/api/saying/:id" },

  //blogPost的权限验证名单
  { method: "POST", path: "/api/blogPost" },
  { method: "DELETE", path: "/api/blogPost/:id" },


  //comment的权限验证名单
  { method: "DELETE", path: "/api/comment/:id" },
];
